...
# efficiencies = [s / workers for s in speedups]
...
ax.set_yticklabels(workers, fontsize=18)
...
#                            loc='upper left', frameon=True, facecolor='white', edgecolor='black', ncols = 2,
#                            framealpha=1.0, shadow=True, fontsize=12.5, labelspacing=0.09, columnspacing=1.02, bbox_to_anchor=(0.005, 1.003))
dataset_legend = ax.legend(handles=dataset_handles, labels=labels,
                           loc='upper left', frameon=True, facecolor='#1a1a1a', edgecolor='white', ncols = 2,
                           framealpha=1.0, shadow=True, fontsize=12.5, labelspacing=0.09, columnspacing=1.02, bbox_to_anchor=(0.005, 1.003))
...
# ax.legend(handles=ideal_handle, labels=['Ideal Speedup'], loc='upper left', 
...
plt.savefig("Fig2.png", dpi=600, bbox_inches="tight", transparent=True)